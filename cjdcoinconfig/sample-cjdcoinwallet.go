...
; The server and port used for cjdcoind websocket connections.
; rpcconnect=localhost:18334

; File containing root certificates to authenticate a TLS connections with cjdcoind
; cafile=~/.cjdcoinwallet/cjdcoind.cert
...
; rpccert=~/.cjdcoinwallet/rpc.cert
; rpckey=~/.cjdcoinwallet/rpc.key
...
; Username and password to authenticate to cjdcoind a RPC server and authenticate
; new client connections
; rpcuser=
; rpcpass=

; Alternative username and password for cjdcoind.  If set, these will be used
