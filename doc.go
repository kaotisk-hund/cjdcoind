...
The default options are sane for most users.  This means cjdcoind will work 'out of
...
parsed when cjdcoind starts up.  By default, the configuration file is located at
~/.cjdcoind/cjdcoind.conf on POSIX-style operating systems and %LOCALAPPDATA%\cjdcoind\cjdcoind.conf
