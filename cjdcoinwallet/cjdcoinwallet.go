...
import (
	...
	"github.com/kaotisk-hund/cjdcoind/cjdcoinwallet/rpc/legacyrpc"
...
func main() {
	version.SetUserAgentName("cjdcoinwallet")
...
// startChainRPC opens a RPC client connection to a cjdcoind server for blockchain
