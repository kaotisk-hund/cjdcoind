...
import "github.com/kaotisk-hund/cjdcoind/chaincfg"
...
// btcd on the cjdcoin.cash test network (wire.PktTestNet).
...
// btcd on the cjdcoin.cash main network (wire.PktMainNet).
