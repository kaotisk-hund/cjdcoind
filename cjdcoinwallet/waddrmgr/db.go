...
import (
	...
	"github.com/kaotisk-hund/cjdcoind/cjdcoinwallet/wallet/seedwords"
...
type ObtainUserInputFunc func() ([]byte, er.R)
...
func fetchScopeAddrSchema(ns walletdb.ReadBucket,
	scope *KeyScope) (*ScopeAddrSchema, er.R) {
...
func fetchWriteScopeBucket(ns walletdb.ReadWriteBucket,
	scope *KeyScope) (walletdb.ReadWriteBucket, er.R) {
...
func fetchManagerVersion(ns walletdb.ReadBucket) (uint32, er.R) {
...
func putManagerVersion(ns walletdb.ReadWriteBucket, version uint32) er.R {
...
func fetchMasterKeyParams(ns walletdb.ReadBucket) ([]byte, []byte, er.R) {
...
func putMasterKeyParams(ns walletdb.ReadWriteBucket, pubParams, privParams []byte) er.R {
	bucket := ns.NestedReadWriteBucket(mainBucketName)
...
func fetchCoinTypeKeys(ns walletdb.ReadBucket, scope *KeyScope) ([]byte, []byte, er.R) {
...
func putMasterHDKeys(ns walletdb.ReadWriteBucket, masterHDPrivEnc, masterHDPubEnc []byte) er.R {
...
func fetchMasterHDKeys(ns walletdb.ReadBucket) ([]byte, []byte, er.R) {
	bucket := ns.NestedReadBucket(mainBucketName)
...
func fetchWatchingOnly(ns walletdb.ReadBucket) (bool, er.R) {
	bucket := ns.NestedReadBucket(mainBucketName)
...
func putWatchingOnly(ns walletdb.ReadWriteBucket, watchingOnly bool) er.R {
	bucket := ns.NestedReadWriteBucket(mainBucketName)
...
func deserializeDefaultAccountRow(accountID []byte, row *dbAccountRow) (*dbDefaultAccountRow, er.R) {
...
func deserializeNetworkStewardVoteRow(account uint32, raw []byte) (*dbNetworkStewardVote, er.R) {
...
func forEachKeyScope(ns walletdb.ReadBucket, fn func(KeyScope) er.R) er.R {
...
func forEachAccount(ns walletdb.ReadBucket, scope *KeyScope,
	...
	return acctBucket.ForEach(func(k, v []byte) er.R {
		// Skip buckets.
		if v == nil {
			return nil
		}
...
func fetchLastAccount(ns walletdb.ReadBucket, scope *KeyScope) (uint32, er.R) {
	scopedBucket, err := fetchReadScopeBucket(ns, scope)
	if err != nil {
		return 0, err
	}
...
func fetchAccountNetworkStewardVote(ns walletdb.ReadBucket,
	scope *KeyScope, account uint32) (*dbNetworkStewardVote, er.R) {
...
func putAccountNetworkStewardVote(ns walletdb.ReadWriteBucket, scope *KeyScope,
	account uint32, vote *dbNetworkStewardVote) er.R {
	scopedBucket, err := fetchWriteScopeBucket(ns, scope)
	if err != nil {
		return err
	}
...
func putAddrAccountIndex(ns walletdb.ReadWriteBucket, scope *KeyScope,
	account uint32, addrHash []byte) er.R {
...
func putAccountRow(ns walletdb.ReadWriteBucket, scope *KeyScope,
	account uint32, row *dbAccountRow) er.R {
...
func putAccountInfo(ns walletdb.ReadWriteBucket, scope *KeyScope,
	...
	nextExternalIndex, nextInternalIndex uint32, name string) er.R {
...
func deserializeAddressRow(serializedAddress []byte) (*dbAddressRow, er.R) {
...
func deserializeChainedAddress(row *dbAddressRow) (*dbChainAddressRow, er.R) {
...
func deserializeImportedAddress(row *dbAddressRow) (*dbImportedAddressRow, er.R) {
...
func deserializeScriptAddress(row *dbAddressRow) (*dbScriptAddressRow, er.R) {
...
func putAddress(ns walletdb.ReadWriteBucket, scope *KeyScope,
	addressID []byte, row *dbAddressRow) er.R {
...
func putChainedAddress(ns walletdb.ReadWriteBucket, scope *KeyScope,
	...
	index uint32, addrType addressType) er.R {
...
func putImportedAddress(ns walletdb.ReadWriteBucket, scope *KeyScope,
	...
	encryptedPubKey, encryptedPrivKey []byte) er.R {
...
func putScriptAddress(ns walletdb.ReadWriteBucket, scope *KeyScope,
	addressID []byte, account uint32, status syncStatus,
	encryptedHash, encryptedScript []byte) er.R {
...
func forEachAccountAddress(ns walletdb.ReadBucket, scope *KeyScope,
	account uint32, fn func(rowInterface interface{}) er.R) er.R {
...
func forEachActiveAddress(ns walletdb.ReadBucket, scope *KeyScope,
	fn func(rowInterface interface{}) er.R) er.R {
...
func deletePrivateKeys(ns walletdb.ReadWriteBucket) er.R {
	bucket := ns.NestedReadWriteBucket(mainBucketName)
	...
	err := scopeBucket.ForEach(func(scopeKey, _ []byte) er.R {
		if len(scopeKey) != 8 {
			return nil
		}
...
// database.
func fetchSyncedTo(ns walletdb.ReadBucket) (*BlockStamp, er.R) {
...
// database.
func fetchBlockHash(ns walletdb.ReadBucket, height int32) (*chainhash.Hash, er.R) {
	bucket := ns.NestedReadBucket(syncBucketName)
...
func addBlockHash(ns walletdb.ReadWriteBucket, height int32, hash chainhash.Hash) er.R {
...
// given height.
func deleteBlockHash(ns walletdb.ReadWriteBucket, height int32) er.R {
	var rawHeight [4]byte
	binary.BigEndian.PutUint32(rawHeight[:], uint32(height))
	bucket := ns.NestedReadWriteBucket(syncBucketName)
...
// block.
func updateSyncedTo(ns walletdb.ReadWriteBucket, bs *BlockStamp) er.R {
	// The serialized synced to format is:
	//   <blockheight><blockhash><timestamp>
	//
...
// database.
func FetchStartBlock(ns walletdb.ReadBucket) (*BlockStamp, er.R) {
	bucket := ns.NestedReadBucket(syncBucketName)
...
func putStartBlock(ns walletdb.ReadWriteBucket, bs *BlockStamp) er.R {
	bucket := ns.NestedReadWriteBucket(syncBucketName)
...
func fetchBirthday(ns walletdb.ReadBucket) (time.Time, er.R) {
	var t time.Time
...
func putBirthday(ns walletdb.ReadWriteBucket, t time.Time) er.R {
...
func FetchBirthdayBlock(ns walletdb.ReadBucket) (BlockStamp, er.R) {
...
func DeleteBirthdayBlock(ns walletdb.ReadWriteBucket) er.R {
	bucket := ns.NestedReadWriteBucket(syncBucketName)
...
//
// NOTE: This does not alter the birthday block verification state.
func PutBirthdayBlock(ns walletdb.ReadWriteBucket, block BlockStamp) er.R {
...
func putBirthdayBlockVerification(ns walletdb.ReadWriteBucket, verified bool) er.R {
...
func createScopedManagerNS(ns walletdb.ReadWriteBucket, scope *KeyScope) er.R {
...
func createManagerNS(ns walletdb.ReadWriteBucket,
	defaultScopes map[KeyScope]ScopeAddrSchema) er.R {
