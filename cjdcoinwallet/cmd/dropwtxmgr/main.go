...
var datadir = btcutil.AppDataDir("cjdcoinwallet", false)
...
func mainInt() int {
	...
	for !opts.Force {
		fmt.Print("Drop all cjdcoinwallet transaction history? [y/N] ")
	...
	fmt.Println("Dropping cjdcoinwallet transaction history")
