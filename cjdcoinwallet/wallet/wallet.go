...
import (
	...
	"github.com/kaotisk-hund/cjdcoind/cjdcoinwallet/wallet/watcher"
	"github.com/kaotisk-hund/cjdcoind/cjdcoinwallet/wallet/workqueue"
...
// blockchain or cjdcoind mempool), the next chained address is returned.
...
func (w *Wallet) publishTransaction(tx *wire.MsgTx) (*chainhash.Hash, er.R) {
	...
	// confirmed to a cjdcoind/bitcoind node over RPC.
