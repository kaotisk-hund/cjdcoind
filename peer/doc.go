...
function which allows a cjdcoinlog.Logger to be specified.  For example, logging at
...
(https://godoc.org/github.com/kaotisk-hund/cjdcoind/wire#hdr-Bitcoin_Improvement_Proposals)
*/
package peer
