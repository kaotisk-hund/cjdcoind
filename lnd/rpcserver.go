...
import (
	...
	"github.com/kaotisk-hund/cjdcoind/lnd/chanacceptor"
	"github.com/kaotisk-hund/cjdcoind/lnd/chanbackup"
	"github.com/kaotisk-hund/cjdcoind/lnd/chanfitness"
	...
	"github.com/kaotisk-hund/cjdcoind/lnd/lnwallet/chanfunding"
	"github.com/kaotisk-hund/cjdcoind/lnd/lnwire"
	"github.com/kaotisk-hund/cjdcoind/lnd/macaroons"
	"github.com/kaotisk-hund/cjdcoind/lnd/monitoring"
	"github.com/kaotisk-hund/cjdcoind/lnd/peer"
	...
	"github.com/kaotisk-hund/cjdcoind/cjdcoinwallet/wallet/txauthor"
...
func (r *rpcServer) BakeMacaroon0(ctx context.Context,
	req *lnrpc.BakeMacaroonRequest) (*lnrpc.BakeMacaroonResponse, er.R) {
	...
	if len(req.Permissions) == 0 {
		return nil, er.Errorf("permission list cannot be empty. "+
	...
	for idx, op := range req.Permissions {
		if !stringInSlice(op.Entity, validEntities) {
			return nil, er.Errorf("invalid permission entity. %s",
				helpMsg)
		}
	...
	newMacBytes, errr := newMac.M().MarshalBinary()
	if errr != nil {
